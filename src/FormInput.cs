    ...
    public partial class FormInput : Form
    {
        ...
        public FormInput(string caption, string label, string txt, bool ML, gInk.Root rt = null, Microsoft.Ink.Stroke stk = null)
        {
            ...
            if (ML)
            {
                ...
                // rendre la textbox "visuellement transparente" en lui donnant la même couleur que TransparencyKey
                InputML.BackColor = this.BackColor;
                InputML.ForeColor = Color.White;
                //InputML.ForeColor = this.BackColor; // <- texte transparent
                InputML.BorderStyle = BorderStyle.None;

                // Si nous créons une nouvelle saisie (stk == null), toujours démarrer avec un champ vide.
                if (stk == null)
                {
                    InputML.Text = "";
                }
            ...
            // Envoi inconditionnel de la touche SUPPR juste après affichage
            this.Shown += new EventHandler(FormInput_Shown);
        ...
        private void FormInput_Shown(object sender, EventArgs e)
        {
            try
            {
                // Envoi inconditionnel de la touche SUPPR / DEL après ouverture
            ...
            {
                // détacher pour n'exécuter qu'une seule fois
                this.Shown -= FormInput_Shown;
            }
        }
